...
import { extractVariables, renderTemplate } from "@entities/prompt";
import { useCopyToClipboard } from "@shared/hooks";
import {
  updatePromptSchema,
  type UpdatePromptFormData,
} from "@entities/prompt";
import { VISIBILITY_OPTIONS } from "@entities/prompt";
import { useUpdatePrompt } from "@features/prompt-crud";
import { Button } from "@shared/ui";
import { Input } from "@shared/ui";
import { AutoExpandTextarea } from "@shared/ui";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { CopyPromptDropdown } from "@features/prompt-crud";
import { DeletePromptDialog } from "@features/prompt-crud";
import { PromptActionsDropdown } from "@features/prompt-crud";
import { HighlightedContent, VariablesList } from "@entities/prompt";
import { VariableInputForm } from "@features/prompt-crud";
import { InlineTagEditor } from "@features/tag-management";
import { InlineFolderEditor } from "@features/folder-management";
import { FolderLinkBadge } from "@entities/folder";
import { TagLinkBadges } from "@entities/tag";
import { ImprovePromptModal } from "@features/ai-tools";
import { GenerateDescriptionModal } from "@features/ai-tools";
import { VersionHistorySheet } from "@features/ai-tools";
